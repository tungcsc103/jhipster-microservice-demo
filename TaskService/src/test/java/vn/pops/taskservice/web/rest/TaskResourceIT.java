...
import vn.pops.taskservice.service.TaskService;
import vn.pops.taskservice.web.rest.errors.ExceptionTranslator;
...
import static vn.pops.taskservice.web.rest.TestUtil.sameInstant;
import static vn.pops.taskservice.web.rest.TestUtil.createFormattingConversionService;
...
public class TaskResourceIT {
    ...
    private static final ZonedDateTime SMALLER_EXPIRE_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(-1L), ZoneOffset.UTC);
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getExpireDate()).isEqualTo(DEFAULT_EXPIRE_DATE);
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getExpireDate()).isEqualTo(UPDATED_EXPIRE_DATE);
